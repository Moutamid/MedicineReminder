...
public class StockReminderDatabaseAdapter {

    private DatabaseHelper remindersDatabaseHelper;
    private static final String DATABASE_NAME = "stk_dba_reminders";
    private static final int DATABASE_VERSION = 1;
    private final Context mCtx;
    private SQLiteDatabase remindersDatabase;

    private static final String TABLE_REMINDER = "tbl_rmd_stk";
    ...
    private static final String COL_REMAINING_STOCK = "remain_st";

    private static final int INDEX_REMINDER_ID  = 0;
    private static final int INDEX_REMINDER_TITLE = INDEX_REMINDER_ID + 1;
    private static final int INDEX_REMINDER_STOCK = INDEX_REMINDER_ID + 2;
    private static final int INDEX_REMINDER_DTS = INDEX_REMINDER_ID + 3;
    ...
    private static final String CREATE_TABLE_REMINDER =
            "CREATE TABLE if not exists " + TABLE_REMINDER + " ( " +
                    ...
                    COL_REMAINING_STOCK + " TEXT, " +
                    COL_REMINDER_DTS + " TEXT );";


    protected StockReminderDatabaseAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    protected void updateReminder(int reminderId, String nReminderTitle, String nReminderDTS, String stock){
        ContentValues reminderValues = new ContentValues();

        reminderValues.put(COL_REMINDER_TITLE, nReminderTitle);
        reminderValues.put(COL_REMAINING_STOCK, stock);
    ...
    protected int createReminder(String reminderTitle, String reminderDTS,  String stock) {
        ContentValues reminderValues = new ContentValues();
    ...
    protected List<Reminder> fetchReminders() {
        ...
        Cursor reminderTableCursor = remindersDatabase.query(TABLE_REMINDER, new String[]{COL_REMINDER_ID,
                        COL_REMINDER_TITLE,COL_REMAINING_STOCK,COL_REMINDER_DTS},
        ...
        if (reminderTableCursor != null){
            while (reminderTableCursor.moveToNext()){
                ...
                String reminderStock = reminderTableCursor.getString(INDEX_REMINDER_STOCK);
                ...
                reminder= new Reminder(reminderId, reminderTitle, reminderDOF, reminderTOF, reminderTIM,reminderStock);
